...
<div>
    <div class="alert alert-secondary mx-4" role="alert">
        <span class="text-white">
            <strong>Les fonctions Ajouter, Modifier, Supprimer ne sont pas fonctionnelles ! </strong> l s'agit d'une fonction
            <strong>PRO</strong> Cliquez <strong>
            <a href="https://www.creative-tim.com/live/soft-ui-dashboard-pro-laravel" target="_blank" class="text-white">ici</a></strong>
            pour voir le produit PRO !
        </span>
    </div>
            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        <div>
                            <h5 class="mb-0">Tous les Utilisateur</h5>
                        </div>
                        <a href="#" class="btn bg-gradient-primary btn-sm mb-0" type="button">+&nbsp; Nouvel Utilisateur</a>
                    </div>
                </div>
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">Créateur</p>
                                    </td>
                                    <td class="text-center">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">Membre</p>
                                    </td>
                                    <td class="text-center">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">Créatrice</p>
                                    </td>
                                    <td class="text-center">
